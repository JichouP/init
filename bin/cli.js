...
exports.spinner = new spinner_1.SpinnerHandler();
var init = function () { return __awaiter(void 0, void 0, void 0, function () {
    var response, _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                utils_1.confirmCommandExistence('node', 'npm', "tsc");
                return [4 /*yield*/, prompts_1.default([
                        {
                            ...
                            choices: [
                                ...
                                {
                                    title: 'Express',
                                    value: constants_1.presets.express,
                                },
                                {
                                    title: 'Express + Mongoose',
                                    value: constants_1.presets.express_mongo,
                                },
                            ],
                        },
                    ])];
...
init().catch(function (err) { return console.log(err); });
